 ...
 */
   ...
   public class SKShapeArray extends BaseArray
   {
    ...
    // Append a value to the collection.
	 ...
	 //if(value == null) { System.out.println(" Null value added in base shape!!!") ; stdio.getLine();}
    ...
    // Convert to an array.
      ...
      
      {
         int min = 2000;
         for(int i=0; i<size(); i++)
            if(min>get(i).getShapeX()) min = get(i).getShapeX();
         return min;
      }
      ...
      
      {
         int min = 2000;
         for(int i=0; i<size(); i++)
            if(min>get(i).getShapeY()) min = get(i).getShapeY();
         return min;
      }
      ...
      
      {
         int max = -1;
         for(int i=0; i<size(); i++)
            if(max<get(i).getShapeX()) max = get(i).getShapeX();
         return max;
      }
      ...
      
      {
         int max = -1;
         for(int i=0; i<size(); i++)
            if(max<get(i).getShapeY()) max = get(i).getShapeY();
         return max;
      }
   }
