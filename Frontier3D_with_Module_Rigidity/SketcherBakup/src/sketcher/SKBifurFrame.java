 ...
 */
   ...
   public class SKBifurFrame extends JDialog
   {
      ...
      public int reSolveID = -1; // Added for redo rep[ick task....
      public int rePickID = -1;
      ...
      public SKBifurFrame(Frame owner, String title, boolean modal,SKGTNArray allGroups, int actID, int[] fin)
      {
...
*/
   ...
   */
      ...
      // Added code to do the resolve part!!!! :)
...
//                }
   ...
   */
      ...
      
      {
         ...
         {
	     if(frameMain.panelShapeArea3d.root_group.getChild(i) == null) 
	     	System.out.println("NULL!! " + frameMain.panelShapeArea3d.root_group.numChildren() + " " + i);
