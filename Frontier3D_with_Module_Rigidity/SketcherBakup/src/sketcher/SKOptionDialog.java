 ...
 */
   ...
   public class SKOptionDialog extends JDialog
   {
      ...
      public JComboBox cmbInteractESM = new JComboBox();
	 ...
	 cmbInteractESM.addItem("Get Equations in non-interactive Mode");
         cmbInteractESM.addItem("Get Equations in interactive Mode");
	 ...
	 cmbInteractESM.addItemListener(
                                 ...
                                 new java.awt.event.ItemListener()
                                 {
                                    ...
                                    {
					cmbInteractESM_itemStateChanged(e);
                                    }
                                 });
         cmbInteractESM.setBounds(new Rectangle(134, 127, 440, 20));
         ...
         jLabel6.setText("Choose to interact with equation generator");
         jLabel6.setBounds(new Rectangle(9, 127, 116, 17));
         ...
         panelGeneral.add(cmbInteractESM, null);
      ...
      void this_windowOpened(WindowEvent e)
      {
         ...
         cmbInteractESM.setSelectedIndex( SKOptions.byteOptions[ SKOptions.ESMInteraction ] );
      ...
      void cmbInteractESM_itemStateChanged(ItemEvent e)
      {  
         if (e.getStateChange()==e.SELECTED)
            SKOptions.byteOptions[ SKOptions.ESMInteraction ] =	(byte)cmbInteractESM.getSelectedIndex();
      }
   }
