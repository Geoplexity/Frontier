 ...
 */
   ...
   //Byte Options (options that can be represented by boolean or int -128 <= x <= 127)
      static byte[]     byteOptions = new byte[6];
   ...
   //Color Options
      static Color[]    colorOptions = new Color[11];
      ...
      point3dColor	    = 10;
      static final String[] colorOptionNames = new String[] { "Shape Body","Selected Shape Body","MouseOver Shape Body","Grouped Shape Body" ,"Shape Outline","Selected Shape Outline","MouseOver Shape Outline","Grouped Shape Outline","Color of Fixed Shape","Color of outline of fixed shape", "Color of point in 3d" };
	 ...
	 colorOptions[ point3dColor ] = Color.blue;
      }
