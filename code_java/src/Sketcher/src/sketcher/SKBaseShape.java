...
//This is the base class for all shapes to be implemented as GUI-drawn shapes
   ...
   //Properties
      ...
      public SKBaseShape  clonedShape = null; //Shape this was cloned from
      public SKBaseShape3d shape3d = null;    //Corresponding 3D shape
   ...
   //This is to allow shapes to paint outside of thier boundaries (like line between points for SKLineShape)
      ...
      {
	 if(frameMain.panelShapeArea.DrawShapeNames && !(this instanceof SKPointSubShape))
	    g.drawString(Name.charAt(0)+""+ID, getX()-5,getY()-5);	    
      }
