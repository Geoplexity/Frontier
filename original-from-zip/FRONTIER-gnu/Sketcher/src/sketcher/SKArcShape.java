 ...
 */
   ...
   //Should this shape be drawn?
      ...
      {
      /*arcShape.setFrameFromCenter(center.getX()+(center.getWidth()/2),
                                center.getY()+(center.getHeight()/2),
                                center.getX()+(center.getWidth()/2)+radius,
                                center.getY()+(center.getHeight()/2)+radius);*/
         arcShape.setArc(center.getX()+(center.getWidth()/2)-radius,center.getY()+(center.getHeight()/2)-radius,2*radius,2*radius,orientation-((int)angle/2),(int)angle,java.awt.geom.Arc2D.PIE);
         return arcShape.intersects(x-3,y-3,7,7);
      }
