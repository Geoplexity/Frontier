 ...
 */
   ...
   public abstract class BaseArray
   {
      ...
      public BaseArray(int size, int growth, Class type) {
      ...
      public BaseArray(int size, Class type) {
    ...
    // Convert to an array of specified type.
      ...
      public void copyArrayTo(BaseArray array)
      {
         Object base = getArray();
         Class type = base.getClass().getComponentType();
      
         Object copy = Array.newInstance(type, countPresent);
         System.arraycopy(base, 0, copy, 0, countPresent);
         array.setArray(copy);
         array.countPresent=countPresent;
         array.countLimit=countLimit;
      }
   }