   ...
   while(inputData[idx]>=0)
   {
	...
	NumEdge+=4;
	 ...
	 int temp, vertType;	
	    ...
	    cout<<"Constraint Type="<<constraintType<<" part="<<temp<<endl;
      ...
      if(constraintType==0||constraintType==4||constraintType==6||constraintType==8) { // distance (2 or 3D) or angle
...
//	os<<"Flows do not match for vertex "<<currVert.returnName()<<endl;
     }
