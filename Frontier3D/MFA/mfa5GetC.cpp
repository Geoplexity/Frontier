...
Cluster * getCluster(Graph &F, Graph &graph0)
{
    ...
    cout<<"Getting Cluster "<<nextVerName<<endl;
//    cout<<"Contents of F before new labeling"<<endl;
//    F.output(cout);
