   ...
   //      int config3 = 1;
      ...
      public void drawConstraint(double x1,double y1,double z1,double x2,double y2, double z2, double x3,double y3, double z3, JSelectionPanel3d panel)
      {
         if (frameMain.panelShapeArea.DrawConstraints && frameMain.drawConstrDetails && create)
         {
            ...
            LineAttributes att = new LineAttributes(4.7f,LineAttributes.PATTERN_DASH,true );
	    ...
	    normalize(v1);
	    normalize(v2);
	    x1 = (float)(v1.x*mag1/3+x2);	
	    y1 = (float)(v1.y*mag1/3+y2);	
	    z1 = (float)(v1.z*mag1/3+z2);	
	    x3 = (float)(v2.x*mag2/3+x2);	
	    y3 = (float)(v2.y*mag2/3+y2);	
	    z3 = (float)(v2.z*mag2/3+z2);	
